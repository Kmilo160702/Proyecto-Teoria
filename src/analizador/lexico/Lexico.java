    ...
    private void analizarLexema(String lexema) {
        ...
        if (null == simbolo) {
            if (Automatas.isIdentificador(lexema)) {
                ...
                simbolo = new Simbolo("int", lexema, false);
            } else if (Automatas.isReal(lexema)) {
                simbolo = new Simbolo("float", lexema, false);
            } else if (Automatas.isEspecialCharacter(lexema)) {
                simbolo = new Simbolo("?", lexema, false);
            }
